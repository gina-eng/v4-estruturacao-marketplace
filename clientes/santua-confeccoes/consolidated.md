...
*Gerado em 2026-06-09 16:50 UTC · Ciclo atual: Semana 1 · Cliente: `santua-confeccoes`*
...
*Documento gerado automaticamente a partir de `client.json` + `outputs/*.json`. Re-execute `render_consolidated.py santua-confeccoes` após cada revisão para atualizar.*