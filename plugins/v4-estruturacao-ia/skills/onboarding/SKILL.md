...
Comandos principais:
  /novo-cliente      → Cadastrar um novo cliente (cria pasta, briefing, etc.)
  continuar          → Retomar trabalho (mostra panorama de clientes + próximo passo)
  /duvida [pergunta] → Tirar dúvida sobre o sistema
  /feedback          → Reportar problema ou sugerir melhoria

Fluxo de trabalho:
  1. Cadastre o cliente com /novo-cliente
...
Semanas do processo:
  ...
  Semana 3 — Produção (identidade, brandbook, landing page, copy, CRM, forecast)
...
Próximo passo: cadastre seu primeiro cliente com /novo-cliente

Se tiver dúvidas a qualquer momento, diga /duvida [sua pergunta].
```

Pergunte: "Quer cadastrar o primeiro cliente agora?"

Se sim, inicie a skill `/novo-cliente`.
