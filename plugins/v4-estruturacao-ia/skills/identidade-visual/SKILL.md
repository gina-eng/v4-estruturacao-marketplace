...
description: "Cria o conceito estratégico de identidade visual: paleta de cores, tipografia, diretrizes de forma e prompts de logo para Midjourney. Semi-manual — operador gera logos externamente. Use quando disser /identidade-visual ou 'criar identidade' ou 'paleta de cores' ou 'logo'."
dependencies:
  - posicionamento
inputs:
  - briefing.json
  - posicionamento.json
output: identidade-visual.json
week: 3
type: semi-manual
estimated_time: "6h"
---
...
2. `posicionamento.json` — PUV, posicionamento, território de marca, tom de voz
3. `decisions.jsonl` — decisões anteriores relevantes (especialmente sobre persona e posicionamento)
...
>
> **Para ajustar:**
> 1. O conceito criativo reflete o posicionamento aprovado?
...
Salve o `identidade-visual.json` completo com todas as seções.
...
## Formato do output (identidade-visual.json)
