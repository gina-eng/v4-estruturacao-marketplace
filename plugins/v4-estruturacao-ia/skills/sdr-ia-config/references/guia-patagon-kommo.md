...
O campo de instrucoes e onde voce define COMO o agente se comporta. Cole o texto gerado pela skill scripts-sdr, adaptado para o formato do Patagon.
...
PERSONALIDADE:
[Descricao do tom de voz baseada no brandbook]
...
3. **Ordene** as perguntas na sequencia definida pela skill scripts-sdr
...
| Tom de voz | Avaliar linguagem | Consistente com brandbook |
