...
```json
{
  ...
  "skills": {
    ...
    "persona-icp": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "auditoria-comunicacao": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "pesquisa-mercado": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "posicionamento": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "diagnostico-midia": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "diagnostico-criativos": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "diagnostico-cro": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "identidade-visual": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "brandbook": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "landing-page": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "copy-anuncios": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "criativos-anuncios": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "crm-setup": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "forecast-midia": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "gmb-otimizacao": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "diagnostico-comercial": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "cliente-oculto": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "scripts-sdr": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null},
    "sdr-ia-config": {"status": "pending", "checkpoint": 0, "started_at": null, "completed_at": null}
  }
}
```

Se `modulo_vendas` = false, remova as 4 skills de semana 4-5 (diagnostico-comercial, cliente-oculto, scripts-sdr, sdr-ia-config) do state.json e não crie a pasta `semana-4-5/`.
...
6. Registre a decisão:
   ```bash
   bash scripts/append_decision.sh clientes/{slug}/ "novo-cliente" 0 "Cliente cadastrado. Briefing completo."
   ```
...
Para começar a semana 1, diga: continuar {nome}
```
